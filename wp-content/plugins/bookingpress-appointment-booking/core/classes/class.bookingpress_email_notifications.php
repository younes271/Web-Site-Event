                ...
                if ($bookingpress_is_allowed_email_notification ) {
                    ...
                    case 'Google_Gmail':
                        if(!empty( $this->bookingpress_gmail_client_id) && !empty($this->bookingpress_gmail_client_secret) && !empty($this->bookingpress_gmail_auth_token) ){
                            ...
                            $bookingpress_email_content_data = "From: {$this->bookingpress_email_sender_name} <{$this->bookingpress_email_sender_email}> \r\n";
                            $bookingpress_email_content_data .= 'Reply-To: ' . $bookingpress_email_reply_to_name . '<' . $bookingpress_email_reply_to_email . "> \r\n";
            ...
            switch ( $this->bookingpress_email_notification_type ) {
                ...
                case 'Google_Gmail':
                    if(!empty( $this->bookingpress_gmail_client_id) && !empty($this->bookingpress_gmail_client_secret) && !empty($this->bookingpress_gmail_auth_token) ){
                        ...
                        $bookingpress_email_content_data = "From: {$from_name} <{$from_email}> \r\n";
                        $bookingpress_email_content_data .= 'Reply-To: ' . $reply_to_name . '<' . $reply_to . "> \r\n";
