                                ...
                                <div class="bpa-customize-step-side-panel">
                                    ...
                                    <div class="bpa-cs-sp-sub-module bpa-sm--swtich">
                                        <div class="bpa-sm--item --bpa-is-flexbox">
                                            ...
                                            <template #content>
                                                <span><?php esc_html_e('Category & Service step cannot hide when booking form sequence set to staff selection as first step', 'bookingpress-appointment-booking'); ?></span>
                                            </template>
