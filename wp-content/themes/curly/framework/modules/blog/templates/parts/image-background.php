...
$blog_list_image_id = !empty($image_meta) && curly_mkdf_blog_item_has_link() ? curly_mkdf_get_attachment_id_from_url($image_meta) : '';
$background_image = '';
...
?>
<?php if ($has_featured) { ?>
    <div class="mkdf-post-image-background" <?php curly_mkdf_inline_style($background_image); ?>>
