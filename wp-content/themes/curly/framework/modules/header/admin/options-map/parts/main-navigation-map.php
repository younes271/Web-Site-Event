...
if (!function_exists('curly_mkdf_get_hide_dep_for_header_main_menu_options')) {
    function curly_mkdf_get_hide_dep_for_header_main_menu_options() {
        $hide_dep_options = apply_filters('curly_mkdf_header_main_menu_hide_global_option', $hide_dep_options = array());

        return $hide_dep_options;
    }
}

if (!function_exists('curly_mkdf_header_main_navigation_options_map')) {
    function curly_mkdf_header_main_navigation_options_map() {
        $hide_dep_options = curly_mkdf_get_hide_dep_for_header_main_menu_options();

        $panel_main_menu = curly_mkdf_add_admin_panel(
            array(
                'title' => esc_html__('Main Menu', 'curly'),
        ...
        curly_mkdf_add_admin_section_title(
            array(
                ...
                'title' => esc_html__('Main Menu General Settings', 'curly')
            )
        );

        $drop_down_group = curly_mkdf_add_admin_group(
            array(
                'parent' => $panel_main_menu,
                'name' => 'drop_down_group',
                'title' => esc_html__('Main Dropdown Menu', 'curly'),
                'description' => esc_html__('Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'curly')
            )
        );

        $drop_down_row1 = curly_mkdf_add_admin_row(
            array(
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'label' => esc_html__('Main Dropdown Menu Appearance', 'curly'),
                'description' => esc_html__('Choose appearance for dropdown menu', 'curly'),
                'options' => array(
                    'dropdown-default' => esc_html__('Default', 'curly'),
                    'dropdown-animate-height' => esc_html__('Animate Height', 'curly')
                )
            )
        );
        ...
        $first_level_group = curly_mkdf_add_admin_group(
            array(
                ...
                'description' => esc_html__('Define styles for 1st level in Top Navigation Menu', 'curly')
            )
        );
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Light Menu Hover Text Color', 'curly'),
            )
        );
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Light Menu Active Text Color', 'curly'),
            )
        );

        $first_level_row4 = curly_mkdf_add_admin_row(
            array(
                'parent' => $first_level_group,
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Dark Menu Hover Text Color', 'curly'),
            )
        );
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Dark Menu Active Text Color', 'curly'),
            )
        );

        $first_level_row5 = curly_mkdf_add_admin_row(
            array(
                'parent' => $first_level_group,
        ...
        $first_level_row6 = curly_mkdf_add_admin_row(
            array(
                'parent' => $first_level_group,
        ...
        $first_level_row7 = curly_mkdf_add_admin_row(
            array(
                'parent' => $first_level_group,
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Padding Left/Right', 'curly'),
                'args' => array(
                    'suffix' => 'px'
                )
            )
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Margin Left/Right', 'curly'),
                'args' => array(
                    'suffix' => 'px'
                )
            )
        ...
        $second_level_group = curly_mkdf_add_admin_group(
            array(
                ...
                'title' => esc_html__('2nd Level Menu', 'curly'),
                'description' => esc_html__('Define styles for 2nd level in Top Navigation Menu', 'curly')
            )
        );
        ...
        curly_mkdf_add_admin_field(
            array(
                ...
                'default_value' => '',
                'label' => esc_html__('Hover/Active Color', 'curly')
            )
        );
        ...
        $second_level_wide_group = curly_mkdf_add_admin_group(
            array(
                'parent' => $panel_main_menu,
                'name' => 'second_level_wide_group',
                'title' => esc_html__('2nd Level Wide Menu', 'curly'),
                'description' => esc_html__('Define styles for 2nd level in Wide Menu', 'curly')
            )
        );

        $second_level_wide_row1 = curly_mkdf_add_admin_row(
            array(
        ...
        $second_level_wide_row2 = curly_mkdf_add_admin_row(
            array(
                'parent' => $second_level_wide_group,
        ...
        $second_level_wide_row3 = curly_mkdf_add_admin_row(
            array(
                'parent' => $second_level_wide_group,
        ...
        $third_level_group = curly_mkdf_add_admin_group(
            array(
                ...
                'title' => esc_html__('3nd Level Menu', 'curly'),
                'description' => esc_html__('Define styles for 3nd level in Top Navigation Menu', 'curly')
            )
        );
        ...
        $third_level_row3 = curly_mkdf_add_admin_row(
            array(
                'parent' => $third_level_group,
        ...
        $third_level_wide_group = curly_mkdf_add_admin_group(
            array(
                'parent' => $panel_main_menu,
                'name' => 'third_level_wide_group',
                'title' => esc_html__('3rd Level Wide Menu', 'curly'),
                'description' => esc_html__('Define styles for 3rd level in Wide Menu', 'curly')
            )
        );

        $third_level_wide_row1 = curly_mkdf_add_admin_row(
            array(
        ...
        $third_level_wide_row2 = curly_mkdf_add_admin_row(
            array(
                'parent' => $third_level_wide_group,
        ...
        $third_level_wide_row3 = curly_mkdf_add_admin_row(
            array(
                'parent' => $third_level_wide_group,
    ...
    add_action('curly_mkdf_header_main_navigation_options_map', 'curly_mkdf_header_main_navigation_options_map', 10, 1);
}