...
namespace CurlyMikadof\Modules\Header\Lib;
/**
 * Class CurlyMikadofHeaderConnector
 *
...
class CurlyMikadofHeaderConnector
{
    ...
    public function connect($config = array()) {
        do_action('curly_mkdf_pre_header_connect');
        ...
        if (!empty($config['affect_content'])) {
            add_filter('curly_mkdf_content_elem_style_attr', array($this, 'contentMarginFilter'));
        }

        if (!empty($config['affect_title'])) {
            add_filter('curly_mkdf_title_content_padding', array($this, 'titlePaddingFilter'));
        }

        do_action('curly_mkdf_after_header_connect');
    }
     ...
     *
     * Hooks to curly_mkdf_title_content_padding filter
     *
     * @return int
     */
