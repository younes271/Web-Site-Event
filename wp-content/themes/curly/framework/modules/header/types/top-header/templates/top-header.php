<?php
if ($show_header_top) {
    do_action('curly_mkdf_before_header_top');
    ?>
    ...
    <div class="mkdf-top-bar">
        <?php do_action('curly_mkdf_after_header_top_html_open'); ?>
    ...
    <?php endif; ?>
        ...
        <?php do_action('curly_mkdf_before_header_top_html_close'); ?>
    </div>

    <?php do_action('curly_mkdf_after_header_top');
}