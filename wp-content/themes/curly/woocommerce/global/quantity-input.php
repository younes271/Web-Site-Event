...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'curly' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'curly' );
...
<div class="mkdf-quantity-buttons quantity">
	...
	<input
		...
		<?php echo esc_attr( $is_readonly ) ? 'readonly="readonly"' : ''; ?>
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'curly' ); ?>"
			size="4"
