...
if ( ! class_exists( 'Envato_Theme_Setup_Wizard' ) ) {
	...
	class Envato_Theme_Setup_Wizard {
		...
		public function envato_setup_help_support() {
			...
			<p>Documentation can be accessed from <a href="<?php echo esc_url( 'https://dahzthemes.com/kitring-docs/' );?>" target="_blank"><?php echo esc_html( 'dahzthemes.com/kitring-docs' );?></a><p>
			<p>Support Email can be accessed to <a href="<?php echo esc_url( 'https://mail.google.com/mail/u/0/#inbox' );?>" target="_blank"><?php echo esc_html( 'jolt.dev@gmail.com' );?></a>
				and includes:</p>
			...
			<div class="envato-setup-next-steps">
				...
				<div class="envato-setup-next-steps-last">
					...
					<ul>
						...
						<li class="support"><a href="<?php echo esc_url( 'https://dahzthemes.com/online-docs/' );?>"
						                       target="_blank"><?php esc_html_e( 'Support Email and Documentation', 'kitring' ); ?></a></li>
					</ul>
				</div>
			</div>
			<?php
