...
<header class="wraper_header style-twelve">
			...
			<div class="row header_top">
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-left">
					...
					<div class="header_top_item">
						...
						<ul class="header-contact">
						    <?php if ( ! empty( glamon_global_var( 'header_twelve_header_top_address', '', false ) ) ) : ?>
						        <li class="address"><span class="ti-location-pin"></span> <?php echo wp_kses_post( glamon_global_var( 'header_twelve_header_top_address', '', false ) ); ?></li>
						    <?php endif; ?>
					    </ul>
					    <!-- header-contact -->
					</div>
				...
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right">
					...
					<div class="header_top_item">
						<!-- header-contact -->
						<ul class="header-contact">
						    <?php if ( ! empty( glamon_global_var( 'header_twelve_header_top_email', '', false ) ) ) : ?>
						        <li class="email"><span class="ti-email"></span> <?php echo wp_kses_post( glamon_global_var( 'header_twelve_header_top_email', '', false ) ); ?></li>
						    <?php endif; ?>
						    <?php if ( ! empty( glamon_global_var( 'header_twelve_header_top_phone', '', false ) ) ) : ?>
						        <li class="phone"><span class="ti-mobile"></span> <?php echo wp_kses_post( glamon_global_var( 'header_twelve_header_top_phone', '', false ) ); ?></li>
						    <?php endif; ?>
					    </ul>
					    <!-- header-contact -->
					</div>
	...
	<!-- wraper_header_top -->
	<!-- wraper_header_main -->
	<?php if ( true == glamon_global_var( 'header_twelve_sticky', '', false ) ) { ?>
	    <div data-delay="<?php echo esc_attr( glamon_global_var( 'header_twelve_sticky_delay', '', false ) ); ?>" class="wraper_header_main radiantthemes-sticky-style-<?php echo esc_attr( glamon_global_var( 'header_twelve_sticky_style', '', false ) ); ?>">
	<?php } else { ?>
	...
	<?php } ?>
		<div class="container">
			...
			<div class="header_main">
				<?php if ( glamon_global_var( 'header_twelve_logo', 'url', true ) ) { ?>
					<!-- brand-logo -->
					<div class="brand-logo radiantthemes-retina">
						<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><img src="<?php echo esc_url( glamon_global_var( 'header_twelve_logo', 'url', true ) ); ?>" alt="<?php echo esc_attr( glamon_global_var( 'header_twelve_logo', 'alt', true ) ); ?>"></a>
					</div>
					<!-- brand-logo -->
				<?php } ?>
				...
				<nav class="nav visible-lg visible-md hidden-sm hidden-xs">
					<?php
					if ( true == glamon_global_var( 'header_twelve_menu_singlepagemode', '', false ) ) {
        				wp_nav_menu(
                            array(
                                'theme_location'    => 'top',
                                'fallback_cb'       => false,
