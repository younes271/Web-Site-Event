(function ($) {
    ...
    var lastudioAnimatedText = function($selector, settings){
        var self = this,
            $instance = $selector,
    ...
    $(window).on('elementor/frontend/init', function () {
        ...
        window.elementorFrontend.hooks.addAction('frontend/element_ready/lastudio-animated-text.default', function ($scope) {
