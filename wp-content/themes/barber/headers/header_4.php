			...
			<div class="col-md-12 col-sm-12 col-xs-12 hidden-lg hidden-md">
				<div class="header-logo">
					<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
						<?php 
						if(isset($apr_settings['logo2']) && $apr_settings['logo2']!=''){
						$logo_header = (apr_get_meta_value('logo_header_page') != '') ? apr_get_meta_value('logo_header_page') : $apr_settings['logo2']['url'];
				...
				<?php if (is_front_page()) : ?>
					...
					<?php else : ?>
						...
						<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
							...
							<?php
							if ($logo_header && $logo_header != ''):
								echo '<img class="" width="107" height="88" src="' . esc_url(str_replace(array('http:', 'https:'),'', 
									$logo_header)) . '" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" />';
							else:
								bloginfo('name');
							endif;
					...
					<div class="header-center">
						<div class="header-tops">
							<h2 class="logo-mobile hidden-lg hidden-md">
								<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
									<?php
									if ($apr_settings['logo2'] && $apr_settings['logo2']['url']):
										echo '<img class="" width="107" height="88" src="' . esc_url(str_replace(array('http:', 'https:'), '', $apr_settings['logo2']['url'])) . '" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" />';
									else:
										bloginfo('name');
									endif;
									?>
									...
									<div class="header-sidebar">
										...
										<h2 class="logo-sidebar">
											<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
												<?php
												if ($apr_settings['logo2'] && $apr_settings['logo2']['url']):
													echo '<img class=""  src="' . esc_url(str_replace(array('http:', 'https:'), '', $apr_settings['logo2']['url'])) . '" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" />';
												else:
													bloginfo('name');
												endif;
												?>
