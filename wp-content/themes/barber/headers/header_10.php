					...
					<div class="header-container">
							...
							<div class="header-tops">
								<h2 class="logo-mobile hidden-lg hidden-md">
									<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
										<?php 
										if(isset($apr_settings['logo10']) && $apr_settings['logo10']!=''){
										$logo_header = (apr_get_meta_value('logo_header_page') != '') ? apr_get_meta_value('logo_header_page') : $apr_settings['logo10']['url'];
						...
						<div class="header-right">
							...
							<?php	 
								...
								<div id="mini-scart-2" class="mini-cart display-inline-b">
								 <?php echo wp_kses($apr_minicart_template, apr_allow_html()); ?> </div>
							<?php endif; ?>
