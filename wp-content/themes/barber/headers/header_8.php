			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="header-container">
					...
					<div class="header-center">
						...
						<?php if ($apr_settings['header-search-hidden']): ?>
							<div class="header_icon display-inline-b hidden-sm hidden-xs">	                 
								<?php 	  
						...
						<?php endif; ?>
						<?php	 
							if (isset($apr_settings['header-minicart-hidden']) && $apr_settings['header-minicart-hidden'] && class_exists('WooCommerce')) :
							$apr_minicart_template = apr_get_minicart_template();?>
							<div id="mini-scart" class="mini-cart hidden-sm hidden-xs display-inline-b"> <?php echo wp_kses($apr_minicart_template, apr_allow_html()); ?> </div>
						<?php endif; ?>
						
						<?php if (isset($apr_settings['header-myaccount']) && $apr_settings['header-myaccount']) :?>
							<div class="header_icon hidden-sm hidden-xs display-inline-b header-myaccount">
					...
					<div class="header-right">
						...
						<?php endif;?>
						<?php if ($apr_settings['header-search-hidden']): ?>
							<div class="header_icon display-inline-b hidden-lg hidden-md">	                 
								<?php 	  
										$apr_search_template = apr_get_search_form();
										echo '<div class="search-block-top">' .wp_kses($apr_search_template, apr_allow_html()) . '</div>';
								apr_show_language_dropdown(); 
						...
						<?php	 
							if (isset($apr_settings['header-minicart-hidden']) && $apr_settings['header-minicart-hidden'] && class_exists('WooCommerce')) :
							$apr_minicart_template = apr_get_minicart_template();?>
							<div id="mini-scart-2" class="mini-cart display-inline-b hidden-lg hidden-md"> <?php echo wp_kses($apr_minicart_template, apr_allow_html()); ?> </div>
						<?php endif; ?>
						
						<?php if (isset($apr_settings['header-myaccount']) && $apr_settings['header-myaccount']) :?>
							<div class="header_icon display-inline-b header-myaccount hidden-lg hidden-md">
								<i class="<?php echo esc_html($apr_settings['header-myaccount-icon']); ?> btn_togglefilter"></i>
								<div class="header-profile content-filter">
									<?php
										$apr_myaccount_page_id = get_option('woocommerce_myaccount_page_id');
