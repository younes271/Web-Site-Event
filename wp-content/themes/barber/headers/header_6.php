				...
				<?php if (is_front_page()) : ?>
					...
					<?php else : ?>
						...
						<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
							...
							<?php 
							if(isset($apr_settings['logo6']) && $apr_settings['logo6']!=''){
							$logo_header = (apr_get_meta_value('logo_header_page') != '') ? apr_get_meta_value('logo_header_page') : $apr_settings['logo6']['url'];
							...
							elseif ($logo_header && $logo_header != ''):
								echo '<img class="" width="50"  src="' . esc_url(str_replace(array('http:', 'https:'), '', $logo_header)) . '" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" />';
							else:
								bloginfo('name');
							endif;
							?>
				...
				<div class="header-container">
							...
							<div class="nav-sections">
								...
								<div class="tab-content">
									<div id="menu" class="tab-pane active">
										...
										$before_items_wrap = '';
										$after_item_wrap = '';
										if(has_nav_menu('header6')){
											wp_nav_menu(array(
												'theme_location' => 'header6',
					...
					<div class="header-right">
						<div class="header_icon display-inline-b">	                 
							<?php 	                
							if (isset($apr_settings['header6-search']) && $apr_settings['header6-search']) {
						...
						<?php	 
							if (isset($apr_settings['header6-minicart']) && $apr_settings['header6-minicart'] && class_exists('WooCommerce')) :
						...
						<?php endif; ?> 
						<?php if (isset($apr_settings['header6-info']) && $apr_settings['header6-info']) :?>
