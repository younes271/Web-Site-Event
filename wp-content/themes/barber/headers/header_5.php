		...
		<div class="row">
			...
			<div class="col-lg-10 col-md-12 col-sm-12 col-xs-12">
				<div class="open-menu-mobile">
					<p><?php echo esc_html('Me','barber');?></p>
					<i class="lnr lnr-menu"></i>
					<p><?php echo esc_html('Nu','barber');?></p>
				</div>
				<div class="close-menu-mobile hidden-sm hidden-xs">
					<p><?php echo esc_html('Clo','barber');?></p>
					<i class="lnr lnr-cross"></i>
					<p><?php echo esc_html('se','barber');?></p>
				</div>
						...
						<nav id="site-navigation" class="main-navigation">
							<div class="nav-sections">
								<ul class="nav nav-tabs hidden-md hidden-lg" role="tablist">
									...
									<?php endif; ?>
									<?php if (isset($apr_settings['header-minicart']) && $apr_settings['header-minicart'] && class_exists('WooCommerce')) :?>
										<li role="presentation"><a data-toggle="tab" role="tab" href="#cart"><i class="lnr lnr-cart"></i></a></li>
									<?php endif; ?>
									<?php if (isset($apr_settings['header-info']) && $apr_settings['header-info']) :?>
										<li role="presentation"><a data-toggle="tab" role="tab" href="#info"><i class="lnr lnr-indent-increase"></i></a></li>
									<?php endif; ?>
								</ul>
								<div class="tab-content">
									...
									<div id="cart" class="tab-pane hidden-md hidden-lg">
										<?php	 
											...
											<div class="mini-cart display-inline-b"> <?php echo wp_kses($apr_minicart_template, apr_allow_html()); ?> </div>
										<?php endif; ?>
									</div>	
