				...
				<?php if (is_front_page()) : ?>
					...
					<?php else : ?>
						...
						<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
									<?php 
									if(isset($apr_settings['logo3']) && $apr_settings['logo3']!=''){
									$logo_header = (apr_get_meta_value('logo_header_page') != '') ? apr_get_meta_value('logo_header_page') : $apr_settings['logo3']['url'];
								...
								<div class="header-ver">
									<div class="header-sidebar">
										...
										<h2 class="logo-sidebar">
											<a href="<?php echo esc_url(home_url('/')); ?>" rel="home">
												<?php
												if ($apr_settings['logo3'] && $apr_settings['logo3']['url']):
													echo '<img class="" src="' . esc_url(str_replace(array('http:', 'https:'), '', $apr_settings['logo3']['url'])) . '" alt="' . esc_attr(get_bloginfo('name', 'display')) . '" />';
												else:
													bloginfo('name');
												endif;
												?>
