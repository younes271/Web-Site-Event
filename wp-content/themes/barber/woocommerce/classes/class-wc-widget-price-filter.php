 ...
 * @extends  WC_Widget
 */
class apr_filter_WC_Widget_Price_Filter extends WC_Widget {
	...
	public function __construct() {
        ...
        $this->widget_description = esc_html__( 'Shows a price filter slider in a widget which lets you narrow down the list of shown products when viewing product categories.', 'barber' );
        $this->widget_id          = 'woocommerce_price_filter';
        $this->widget_name        = esc_html__( 'WooCommerce Price Filter', 'barber' );
        $this->settings           = array(
            'title'  => array(
                'type'  => 'text',
                'std'   => esc_html__( 'Filter by price', 'barber' ),
	...
	echo '<form method="get" action="' . esc_url( $form_action ) . '">
            <div class="price_slider_wrapper price_scale">
                ...
                <div class="price_slider_amount">
                    <input type="text" id="min_price" name="min_price" value="' . esc_attr( $min_price ) . '" data-min="' . esc_attr( apply_filters( 'woocommerce_price_filter_widget_min_amount', $min ) ) . '" placeholder="' . esc_attr__( 'Min price', 'barber' ) . '" />
                    <input type="text" id="max_price" name="max_price" value="' . esc_attr( $max_price ) . '" data-max="' . esc_attr( apply_filters( 'woocommerce_price_filter_widget_max_amount', $max ) ) . '" placeholder="' . esc_attr__( 'Max price', 'barber' ) . '" />
                    ...
                    <button type="submit" class="button btn-default">'.'<span>'. esc_html__( 'Filter', 'barber' ) .'</span>'.'</button>
                    ' . $fields . '
                    <div class="clear"></div>
                </div>
            </div>
